...
export const QuestionTypeDeleteDialog = (props: IQuestionTypeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="psychologicallyTestBackendApp.questionType.delete.question">
        <Translate contentKey="psychologicallyTestBackendApp.questionType.delete.question" interpolate={{ id: questionTypeEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-questionType" color="danger" onClick={confirmDelete}>

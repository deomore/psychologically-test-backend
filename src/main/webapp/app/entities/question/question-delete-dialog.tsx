...
export const QuestionDeleteDialog = (props: IQuestionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="psychologicallyTestBackendApp.question.delete.question">
        <Translate contentKey="psychologicallyTestBackendApp.question.delete.question" interpolate={{ id: questionEntity.id }}>

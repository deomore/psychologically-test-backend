package ru.vlsu.psytest.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ru.vlsu.psytest.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ru.vlsu.psytest.repository.UserRepository.USERS_BY_EMAIL_CACHE);
